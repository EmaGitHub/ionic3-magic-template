  ...
  ngOnInit(){
    ...
    switch(this.title){
      ...
      case 'DISCOUNT_EVENTS_LABEL': 
        ...
        {shortTitle: 'Antiche Camelie', type: 'MOSTRA', title: 'Mostra sulle Antiche Camelie'}, {shortTitle: 'Carnevale di Bocco', type: 'SPETTACOLO'}, {shortTitle: 'Antichi egizi', type: 'MOSTRA'}, {shortTitle: 'Assedio alla Villa', type: 'SPETTACOLO'}, {shortTitle: 'Futuro e tecnologia', type: 'MOSTRA'}];
        break;
